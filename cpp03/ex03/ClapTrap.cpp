...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/04/12 19:22:44 by ykai-yua          #+#    #+#             */
/*   Updated: 2025/04/12 19:22:46 by ykai-yua         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap() : name("default_clap_name"), hitPoints(10), energyPoints(10), attackDamage(0) {
    std::cout << "ClapTrap " << name << " (default constructor) created with "
